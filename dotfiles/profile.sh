export PATH=/usr/local/share/python:/usr/local/opt/ruby/bin:/usr/local/bin:/usr/local/sbin:"/Applications/Android Studio.app/sdk/platform-tools":~/node_modules/.bin:/usr/local/share/npm/bin:~/bin:$PATH
